...
class SqliteSearch extends StatefulWidget {
  @override
  SqliteSearchState createState() => SqliteSearchState();
}

class SqliteSearchState extends State<SqliteSearch> {
  ...
  Widget buildBook(Farmerdata book) => ListTile(
        onTap: () => navigateToNextActivity(context, book.id),
