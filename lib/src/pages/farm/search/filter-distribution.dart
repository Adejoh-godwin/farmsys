import 'dart:async';
import 'package:farmsys/src/pages/farm/inputdistribution.dart';
...
class FilterDistribution extends StatefulWidget {
  @override
  FilterDistributionState createState() => FilterDistributionState();
}

class FilterDistributionState extends State<FilterDistribution> {
  ...
  _navigateToDetail(BuildContext context, Farmerdata models) async {
    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => InputDistribution(models: models)),
    );
  }
}
